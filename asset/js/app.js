    ...
    $(document).ready(function() {
        ...
        // window.setInterval(location.reload(".last-message"), 5000);
        ...
        /*function refreshChat() {
            var parentElement = $(this).parent();
            var incoming_id = parentElement.find('incoming_id').val();
            var outgoing_id = parentElement.find('outgoing_id').val();
